...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    compression: {
      ...
      hygieneHardMessageLimit: 'Limite de limpeza de mensagens',
      hygieneHardMessageLimitHint: 'Forcar limpeza quando o historico bruto exceder esta quantidade de mensagens',
    },
    session: {
